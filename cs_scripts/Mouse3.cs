...
public partial class Mouse3 : CharacterBody2D
{
    ...
    {
        if (area.IsInGroup("ThornGroup") && area is Thorn3 thorn && !thorn.HasTouchedGround)
        {
            var buttonTwo = GetNode<Button4>("../Level Design/Button4");

...
public partial class Boss : CharacterBody2D
{
    ...
    [Export] public CharacterBody2D[] MouseEnemy;
    ...
    {
        if (area.IsInGroup("ThornGroup") && area is Thorn5 thorn && !thorn.HasTouchedGround)
        {
            var buttonTwo = GetNode<Button88>("../Button88");
            ...
            if (playerNode != null)
            {
                MouseEnemy[0].QueueFree();
                MouseEnemy[1].QueueFree();
                MouseEnemy[2].QueueFree();
